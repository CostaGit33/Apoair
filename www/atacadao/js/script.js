document.addEventListener('DOMContentLoaded', () => {
  ...
  const fornecedoresPorEmpresa = {
    'Atacadão': ['Gujão', 'São Benedito', 'Gameleira', 'Bonomilho', 'Coringa', 'Bivolt', 'Arco Verde', 'Santa Edwiges'],
  };
  ...
  const produtosPorFornecedor = {
    'Gujão': [
      ...
      'Frango Fresquinho',
      'Concorrência Seara',
      'Concorrência Mauricéia'   
    ],

    'Bonomilho': [
      'Flocão de Milho Bonomilho 500g',
      'Flocos de Milho Cuscuz Bonomilho 500g',
      'Fubá Mimoso Bonomilho 1kg',
      'Canjica de Milho Amarela Bonomilho 500g',
      'Milho de Pipoca Bonomilho 500g',
      'Creme de Milho Bonomilho 400g',
      'Mistura para Bolo de Milho Bonomilho 500g',
      'Sêmola de Milho Gritz 0330 Bonomilho 500g',
      'Sêmola de Milho Gritz 1414 Bonomilho 500g',
      'Sêmola de Milho Gritz 3040 Bonomilho 500g'
    ],

    'São Benedito': [
      'Bisc. Broa de Milho 400g',
      'Bisc. Broa de Coco 400g',
      'Bisc. Coco Baiano',
      'Bisc. Coquinho',
      'Bisc. Palitinho Extra',
      'Bisc. Champagne',
      'Bisc. Canela Maxx',
      'Bisc 7 Capas 300g',
      'Bisc. Canela 300g'
    ...
    'Santa Edwiges': [
      ...
      'Sequilho Coco 100g',
      'Cookie Choco 100g',
      'Peppa Mini Leite 100g',
      'Galinha Pint. Leite 100g',
      'Galinha Pint. Choco 100g',
      'Bolo Mini Brigadeiro 40g',
      'Bolo Mini Choco+Marsh 40g',
      'Bolo Mini Baun+Choco 40g',
      'Bolo Mini Morango+Marsh 40g'
    ]
  };

  const storageKey = 'relatoriosAtacadao';
  ...
  function renderizarTabelas() {
    ...
    for (const empresa in dados) {
      for (const fornecedor in dados[empresa]) {
        ...
        logosDiv.innerHTML = `
          <img src="img/atacadao1.png" alt="Atacadão" onerror="this.style.display='none'" />
  ...
  form.addEventListener('submit', (e) => {
    ...
    setTimeout(() => {
      ...
      submitBtn.style.background = 'linear-gradient(135deg, #000000, #ff6600ff, #000000)';
    }, 1500);
  });
